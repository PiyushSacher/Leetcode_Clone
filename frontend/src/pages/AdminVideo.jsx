        ...
        <div>
          ...
          >
            <path
              ...
              strokeWidth="2"
              d="M10 14h.01M12 2a10 10 0 100 20 10 10 0 000-20zm0 12V8"
            />
          </svg>
        ...
        <table className="table table-zebra w-full">
          <thead>
            <tr>
              ...
              <th className="w-2/12">Video Upload</th>
            </tr>
          </thead>
          <tbody>
            {problems.map((problem, index) => (
              <tr key={problem._id}>
                ...
                <td>
                    <div className="flex space-x-2">
                        <NavLink to={`/admin/upload/${problem._id}`} className={`btn bg-pink-300`}>Upload</NavLink>
                    </div>
                </td>
              </tr>
            ))}
